...
if (isset($_POST['edited_order']))
{
    ...
    echo "<script>alert('Status riwayat pesanan berhasil diperbarui!'); window.location.href='view-more-past-order.php?v_id=".$row['id']."';</script>";
}
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Ubah Status Riwayat Pesanan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Ubah Status Riwayat</li>
            </ol>
          </div>
        </div>
      </div></section>
          ...
          <div class="col-md-8">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Formulir Perubahan Status</h3>
              </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <select class="form-control" name="status" required>
                        ...
                        <option value="Cancelled-By-Supplier" <?php if($row['status']=="Cancelled-By-Supplier"){ echo "selected"; } ?>>Dibatalkan (Oleh Toko)</option>
                        <option value="Cancelled-By-Client" <?php if($row['status']=="Cancelled-By-Client"){ echo "selected"; } ?>>Dibatalkan (Oleh Pelanggan)</option>
                      </select>
                    </td>
                  </tr>
                  <tr>
